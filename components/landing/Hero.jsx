  ...
  return (
    <section className="py-14 px-6 md:px-20 lg:px-32">
      <div className="grid gap-2 sm:text-center sm:place-items-center sm:max-w-lg md:max-w-2xl sm:mx-auto lg:max-w-[900px]">
        <h1 className="font-semibold text-4xl md:text-5xl lg:text-7xl">Open-Source url shortener With <span className="underline underline-offset-[5px] decoration-blue-400">Analytics</span> & <span className="underline underline-offset-[5px] decoration-blue-400">QR Code</span></h1>
        <p className="text-muted-foreground mt-2 md:text-lg text-base max-w-2xl">I have coded this url shortner using nextjs 14, shadcn/ui & mongodb client mongoose with detailed analytics of links being clicked!</p>
